        ...
        for _, value_shit_meta in enumerate(range_shit_meta):
            for _, value_shit_inner in enumerate(range_shit_inner):
                ...
                if np.nanmean(all_individual_cum_errors) < best_cumsum_perf:
                    ...
                    print('inner wealth: %5.2f | meta wealth: %5.2f |       perf: %7.4f' % (value_shit_inner, value_shit_meta, np.nanmean(all_individual_cum_errors)))
                else:
                    print('inner wealth: %5.2f | meat  wealth: %5.2f | perf: %7.4f' % (value_shit_inner, value_shit_meta, np.nanmean(all_individual_cum_errors)))
